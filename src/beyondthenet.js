...
const sectionTitles = ['Overview', 'Features', 'Research', 'Design', 'User Flow']
const sectionMapping = [0, 1, 1, 1, 2, 2, 2, 2, 3, 4, 4]
...
app.innerHTML = `
  <div class="sc-page">
    ...
    <div class="sc-page-title" aria-label="Project name">
      <h1 class="sc-page-title__text">BEYOND THE NET</h1>
