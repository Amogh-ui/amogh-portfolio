      ...
      <div class="sc-scroll-frame">
        ...
        <div class="sc-scroll-track" id="sc-scroll-track">
          ...
          <img
            ...
            alt="Concept — user journey mapping"
            data-section="2"
            loading="lazy"
          />
          <img
          ...
          <img
            ...
            alt="Concept — typography, colors, beta testing"
            data-section="2"
            loading="lazy"
          />
          <img
          ...
          <img
            ...
            alt="Branding — final screens and interactions"
            data-section="3"
            loading="lazy"
          />
          <img
            ...
            alt="Testing — final prototype walkthrough"
            data-section="4"
            loading="lazy"
          />
        </div>
